...
func (c *providerPluginClient) Init(ctx context.Context, in *ProviderInit_Request, opts ...grpc.CallOption) (*ProviderInit_Response, error) {
	...
	err := c.cc.Invoke(ctx, ProviderPlugin_Init_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerPluginClient) Name(ctx context.Context, in *ProviderName_Request, opts ...grpc.CallOption) (*ProviderName_Response, error) {
	...
	err := c.cc.Invoke(ctx, ProviderPlugin_Name_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerPluginClient) Version(ctx context.Context, in *ProviderVersion_Request, opts ...grpc.CallOption) (*ProviderVersion_Response, error) {
	...
	err := c.cc.Invoke(ctx, ProviderPlugin_Version_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerPluginClient) GetInfo(ctx context.Context, in *GetInfo_Request, opts ...grpc.CallOption) (*GetInfo_Response, error) {
	...
	err := c.cc.Invoke(ctx, ProviderPlugin_GetInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerPluginClient) GetCommits(ctx context.Context, in *GetCommits_Request, opts ...grpc.CallOption) (*GetCommits_Response, error) {
	...
	err := c.cc.Invoke(ctx, ProviderPlugin_GetCommits_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerPluginClient) GetReleases(ctx context.Context, in *GetReleases_Request, opts ...grpc.CallOption) (*GetReleases_Response, error) {
	...
	err := c.cc.Invoke(ctx, ProviderPlugin_GetReleases_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProviderPluginServer) GetReleases(context.Context, *GetReleases_Request) (*GetReleases_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GetReleases not implemented")
}
